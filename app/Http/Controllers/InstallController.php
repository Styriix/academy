...
class InstallController extends Controller
{
    ...
    public function confirmInstalling(Request $request)
    {
        ...
        if (\Schema::hasTable('migrations')) {
            ...
            if (count($migration) > 0) {
                ...
                $staff->mobile  = '+2348012345765';
                $staff->emergency_mobile  = '+2348012345765';
                ...
                $staff->driving_license_ex_date  = '2022-02-23';
                $staff->save();
    ...
    //     $product_info = $client->request('GET', 'http://salespanel.acedemy.com/api/installation/'.$purchase_code.'/'.$domain.'/'.$email); 
    //     $product_info = $product_info->getBody()->getContents(); 
    //     $product_info = json_decode($product_info);  

    //     if($product_info->data->product_info != ""){ 
    //         $res = $client->request('GET', 'http://salespanel.acedemy.com/api/verified/email/'.$purchase_code.'/'.$email); 
    //         return redirect('login');
