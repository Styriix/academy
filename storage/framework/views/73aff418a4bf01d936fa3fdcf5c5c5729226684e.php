    ...
    <table class="table">
        <thead>
            <tr >
                ...
                <th> 
                    ...
                    <p class="text-white mb-0"> <?php echo e(isset($address)?$address:'AceDemy School Address'); ?> </p>
                </th>
        ...
        <tbody>
            <tr>
                ...
                <td> 
                    <p style="font-weight: 500; border-bottom:1px solid #ddd"><?php echo app('translator')->getFromJson('lang.subjects'); ?> <?php echo app('translator')->getFromJson('lang.list'); ?></p> 
                    <div class="row">
