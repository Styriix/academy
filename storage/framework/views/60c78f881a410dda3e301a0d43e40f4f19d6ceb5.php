...
<head>
 ...
 <title> AceDemy school management software & School management system </title>
<meta name="description" content="AceDemy is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
...
[ {
  ...
  "name" : "ACEDEMY - Best School Management software system",
  "url" : "http://acedemy.com/",
  "author" : {
    "@type" : "Company",
    "name" : "Spondon IT"
  },
  ...
  "downloadUrl" : "http://acedemy.com",
  "operatingSystem" : "2019",
  "requirements" : "in a complete",
  "screenshot" : "http://acedemy.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@AceDemy"/>
        <meta name="twitter:creator" content="@AceDemy"/>
        ...
        <meta name="twitter:description" content="AceDemy is a well known School management system and its ERP based Software. So try the free demo today!. Cause AceDemy offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school, college, university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:image" content="http://acedemy.com/public/landing/img/dashboard_preview.png"/>


        <!-- Open Graph data -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="//acedemy.com/"/>
        <meta property="og:image" content="//acedemy.com/public/landing/img/dashboard_preview.png"/>
        <meta property="og:title" content="School Management ERP Software & School Management System - AceDemy"/>

        <meta property="og:description" content="AceDemy is a well known School management system and its ERP based Software. So try the free demo today!. Cause AceDemy offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school, college, university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:site_name" content="AceDemy" />

    <link rel="canonical" href="http://acedemy.com" hreflang="en-us" />
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Managing various administrative tasks in one place is now quite easy and time
                                savior with this ACEDEMY and Give your valued time to your institute that will
                            ...
                            <a id="play-video_1" class="btn_1 popup-youtube" href="#"> <i class="ti-control-play"></i> 
                                Video Overview</a>
                            <a href="<?php echo e(url('/login')); ?>" class="btn_2" target="_blank"> <i class="ti-package"></i> Try Live Demo</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.acedemy.com/">Purchase</a> -->
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>ACEDEMY has all in one place. You’ll find everything what you are looking into education
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>You know! Smart Idea always comes to well planners. And Our ACEDEMY is Smart for its Well
                                Documentation.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="video_section_text">
                        <h2>Take A look Our ACEDEMY Overview in Video</h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-8">
                    <div class="section_tittle text-center">
                        <h5>AMazing Features</h5>
                        <h2>More Features Has ACEDEMY</h2>
                        <p>it's vast! AceDemy has more additional feature that will expect in a complete solution.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <p>We Believe! It won’t a wrong decision in Purchasing our ACEDEMY for your Institute.</p>
                        <!-- <a href="http://salespanel.acedemy.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
