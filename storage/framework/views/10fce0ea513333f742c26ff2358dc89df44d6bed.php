...
if(isset($setting->copyright_text)){ $copyright_text = $setting->copyright_text; }else{ $copyright_text = 'Copyright © 2019 All rights reserved | This template is made with by AceNetics'; }
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-12 text-center">
					<p  style="margin-top: 25px !important;"><?php echo $copyright_text; ?></p>
				</div>
			</div>
		</div> 
	</section> 
