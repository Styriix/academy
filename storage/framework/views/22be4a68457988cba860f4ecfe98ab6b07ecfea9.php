<?php
    ...
    if(empty ( $config)){
          ...
          [
              'copyright_text'=>'Copyright &copy; 2019 All rights reserved | This template is made with <span class="ti-heart"> </span> by AceNetics',
              'logo'=>'public/uploads/settings/logo.png',
              'favicon'=>'public/uploads/settings/favicon.png',
              'currency'=>'USD',
              'school_name'=>'AceDemy Edu',
              'date_format_id'=>1,
              'site_title'=>'AceDemy Edu' 
          ]
         ]); 
    } 
