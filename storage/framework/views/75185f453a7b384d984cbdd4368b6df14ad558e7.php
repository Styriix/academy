<?php
    ...
    if (isset($setting->copyright_text)) {
        ...
        $copyright_text = 'Copyright © 2019 All rights reserved | This template is made with by AceNetics';
    }
...
<head>
    <meta charset="utf-8"/>
    <meta name="viewport"
          content="AceDemy is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution"/>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box-1420">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>/home">
                    <img class="w-75" src="<?php echo e(asset($logo)); ?>" alt="AceDemy Logo" style="max-width: 150px;">
                </a>
