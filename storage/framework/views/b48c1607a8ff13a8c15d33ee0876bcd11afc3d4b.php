...
<head>
    ...
    <link rel="alternate" href="http://acedemy.com" hreflang="en-us" />
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to AceDemy </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing AceDemy for your school administration. Please follow the steps to complete AceDemy Edu installation!</p>
