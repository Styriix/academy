        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?php echo e(url('confirm-installing')); ?>">
                    ...
                    <div class="form-group"> 
                        <input type="hidden" class="form-control" name="institution_code" required value="<?php echo e(time()); ?>"> 
                        <input type="hidden" name="institution_address" value="201 Conference Center Way, Bridgeport, WV, 26330"> 
                        <input type="hidden" name="session_year" value="<?php echo e(date('Y')); ?>"> 
                    </div> 
