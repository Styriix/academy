...
class CreateSmCustomLinksTable extends Migration
{
    ...
    public function up()
    {
        ...
        $s->link_label1 = 'About AceDemy';
        $s->link_href1  = 'http://acedemy.com';

        $s->link_label2 = 'AceDemy Home';
        $s->link_href2  = 'http://acedemy.com/home';

        $s->link_label3 = 'Business';
        $s->link_href3  = 'http://acedemy.com';

        $s->link_label4 = 'link_label4';
        $s->link_href4  = 'http://acedemy.com';

        $s->link_label5 = 'link_label5';
        $s->link_href5  = 'http://acedemy.com';

        $s->link_label6 = 'link_label6';
        $s->link_href6  = 'http://acedemy.com';

        $s->link_label7 = 'link_label7';
        $s->link_href7  = 'http://acedemy.com';

        $s->link_label8 = 'link_label8';
        $s->link_href8  = 'http://acedemy.com';

        $s->link_label9  = 'Home';
        $s->link_href9   = 'http://acedemy.com/home';

        $s->link_label10 = 'About';
        $s->link_href10  = 'http://acedemy.com/about';


        $s->link_label11 = 'Contact';
        $s->link_href11  = 'http://acedemy.com/contact';

        $s->link_label12 = 'link_label12';
        $s->link_href12  = 'http://acedemy.com';

        $s->link_label13 = 'link_label13';
        $s->link_href13  = 'http://acedemy.com';

        $s->link_label14 = 'link_label14';
        $s->link_href14  = 'http://acedemy.com';

        $s->link_label15 = 'link_label15';
        $s->link_href15  = 'http://acedemy.com';

        $s->link_label16 = 'link_label16';
        $s->link_href16  = 'http://acedemy.com';

        $s->facebook_url = 'https://www.facebook.com/acenetics/';
        $s->twitter_url  = 'https://twitter.com/acenetics/';
        $s->dribble_url  = 'https://dribbble.com/';
