...
class sm_studentsSeeder extends Seeder
{
    ...
    {
        $faker   = Faker::create();
        $base_Id = ['Male', 'Female', 'Others', 'Islam', 'Christian', 'A+', 'O+', 'B+', 'AB+', 'A-', 'O-', 'B-', 'AB-'];
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            for ($class_id = 1; $class_id <= 10; $class_id++) {
                for ($section_id = 1; $section_id <= 5; $section_id++) {
                    ...
                    $studentEmail = strtolower($student_User_Name) . $i . '@acedemy.com';
                    ...
                    $newUser->email     = strtolower($Father_User_Name) . $i . '@acedemy.com';
                    $newUser->username  = strtolower($Father_User_Name) . $i . '@acedemy.com';
                    $newUser->password  = Hash::make(123456);
                    $newUser->save();
                    $newUser->toArray();
                    ...
                    $parent->guardians_email      = $Guardian_First_Name . $i . '@acedemy.com';
                    ...
                    $parent->guardians_address = 'Lgos, Nigeria';
                    ...
                    DB::table('sm_students')->insert([
                        [
                            ...
                            'gender_id'               => $gender_id,
                            'email'                   => $studentEmail,
                            'mobile'                  => '+2348012345765' . $i,
                            'bank_account_no'         => '+2348012345765' . $i,

                            'bank_name'               => 'DBBL',
                            'student_photo'           => 'public/uploads/student/student.jpg',

                            'current_address'         => 'Nigeria',
                            'previous_school_details' => 'Nigeria',
                            'aditional_notes'         => 'Nigeria',

                            'permanent_address'       => 'Lagos,Nigeria',
                        ],
