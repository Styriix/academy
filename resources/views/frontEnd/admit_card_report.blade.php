                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <select class="multipleSelect" multiple name="language">
                                    <option value="Bangladesh1">Nigeria 1</option>
                                    ...
                                    <option value="Bangladesh2">Nigeria 2</option>
                                    <option value="Barbados2">Barbados 2</option>
                                    <option value="Belarus2">Nigeria 2</option>
                                    <option value="Belgium2">Belgium 2</option>
                                    <option value="Bangladesh3">Nigeria 3</option>
                                    <option value="Barbados3">Barbados 3</option>
                                    <option value="Belarus3">Nigeria 3</option>
                                    <option value="Belgium3">Belgium 3</option>
                                    <option value="Bangladesh4">Nigeria 4</option>
                                    <option value="Barbados4">Barbados 4</option>
                                    <option value="Belarus4">Belarus 4</option>
                                    <option value="Belgium4">Belgium 4</option>
                                    <option value="Bangladesh5">Nigeria 5</option>
                                    <option value="Barbados5">Nigeria 5</option>
