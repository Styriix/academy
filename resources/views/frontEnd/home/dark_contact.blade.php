                    ...
                    <form class="row contact_form mt-50" action="#" method="post" id="contactForm" novalidate="novalidate">
                        <div class="col-lg-12">
                            ...
                            <div class="input-effect mt-20">
                                <input class="primary-input form-control" placeholder="info@AceNetics.com" type="text" id="">
                                <span class="focus-border"></span>
                            </div>
                            <div class="input-effect mt-20">
			...
			<div class="row footer_inner">
				...
				<div class="col-lg-3 col-sm-6">
					<aside class="f_widget ab_widget">
						...
						<ul>
							<li><a href="#"></a>AceDemy Health Care</a></li><a href="#">
                            <li><a href="#"></a>AceDemy Children’s Health</a></li>
							<li><a href="#"></a>Interdisciplinary Research</a></li>
							<li><a href="#"></a>AceDemy Online</a></li>
							<li><a href="#"></a>AceDemy Research Centers</a></li>
						</ul>
					</aside>
				</div>
				<div class="col-lg-3 col-sm-6">
			...
			<div class="row single-footer-widget">
				<div class="col-lg-8 col-md-9">
					<div class="copy_right_text">
						<p>Copyright © 2018 All rights reserved <a href="#">AceDemy</a>. The Ultimate Education ERP</p>
					</div>
				</div>
