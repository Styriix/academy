                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-lg-8 text-left text-lg-right mt-30-md">
                                        <h3 class="text-white"> {{isset($school_name)?$school_name:'AceDemy School Management ERP'}} </h3>
                                        <p class="text-white mb-0"> {{isset($address)?$address:'AceDemy School Adress'}} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h3 class="exam_title text-center text-capitalize">{{isset($school_name)?$school_name:'AceDemy School Management ERP'}} </h3>
                                    <h4 class="exam_title text-center text-capitalize">{{isset($address)?$address:'AceDemy School Adress'}} </h4>
