    ...
    <table class="table" style="width: 100%;">
        ...
        <tr>
            ...
            <th class="text-left">
                ...
                <h3 class="exam_title text-left text-capitalize">{{isset($school_name)?$school_name:'AceDemy School Management ERP'}} </h3>
                <h4 class="exam_title text-left text-capitalize">{{isset($address)?$address:'AceDemy School Adress'}} </h4>
